    ...
    <div class="history-box center-block">
        <div class="row">
            ...
            <div class="col-md-3" style="border: 1px solid #eee;padding:5px;">
                <p class="text-center">Count Ship 1 / Name Ship 1</p>
            </div>
            <div class="col-md-1" style="border: 1px solid #eee;padding:5px;">
                <p class="text-center">Health Ship 1</p>
            </div>
            <div class="col-md-3" style="border: 1px solid #eee;padding:5px;">
                <p class="text-center">Count Ship 2 / Name Ship 2</p>
            </div>
            <div class="col-md-1" style="border: 1px solid #eee;padding:5px;">
                <p class="text-center">Health Ship 2</p>
            </div>
            <div class="col-md-2" style="border: 1px solid #eee;padding:5px;">
                <p class="text-center">Winner</p>
            </div>
        </div>
        <?php foreach ($battles as $battle): ?>
            <div class="row">
                <div class="col-md-2" style="border: 1px solid #eee;padding:5px;">
                    <p><?php echo $battle->getBattleId(); ?> / <?php echo $battle->getBattleDate(); ?></p>
                </div>
                <div class="col-md-3" style="border: 1px solid #eee;padding:5px;">
                    <p><?php echo $battle->getShip1Q(); ?> / <?php echo $battle->getShip1(); ?></p>
                </div>
                <div class="col-md-1" style="border: 1px solid #eee;padding:5px;">
                    <p><?php echo $battle->getShip1Health(); ?></p>
                </div>
                <div class="col-md-3" style="border: 1px solid #eee;padding:5px;">
                    <p><?php echo $battle->getShip2Q(); ?> / <?php echo $battle->getShip2Name(); ?></p>
                </div>
                <div class="col-md-1" style="border: 1px solid #eee;padding:5px;">
                    <p><?php echo $battle->getShip2Health(); ?></p>
                </div>
                <div class="col-md-2" style="border: 1px solid #eee;padding:5px;">
                    <p><?php echo $battle->getWinner(); ?></p>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
